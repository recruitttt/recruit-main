...
function IntakeInput({
  ...
  return (
    <motion.form
      ...
      className="pointer-events-auto absolute bottom-6 left-1/2 z-20 flex w-[min(560px,calc(100%-32px))] -translate-x-1/2 items-center gap-2 rounded-[20px] border border-white/55 bg-[#F8FBFF]/92 p-2 shadow-[0_24px_48px_-24px_rgba(15,23,42,0.22),inset_0_1px_0_rgba(255,255,255,0.80)] backdrop-blur-xl transition-shadow duration-200 hover:shadow-[0_8px_20px_-12px_rgba(15,23,42,0.18)] focus-within:shadow-[0_12px_28px_-12px_rgba(15,23,42,0.22)] focus-within:ring-2 focus-within:ring-[var(--color-accent-glow)] focus-within:ring-offset-1"
    >
