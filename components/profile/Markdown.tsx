...
export function Markdown({ children, className }: MarkdownProps) {
  return (
    <div
      className={cx(
        "prose-sm break-words text-[13px] leading-relaxed text-slate-700",
        "[&_p]:my-2 [&_p:first-child]:mt-0 [&_p:last-child]:mb-0",
        "[&_h1]:mt-3 [&_h1]:mb-1.5 [&_h1]:text-[15px] [&_h1]:font-semibold [&_h1]:text-slate-900",
        "[&_h2]:mt-3 [&_h2]:mb-1.5 [&_h2]:text-[14px] [&_h2]:font-semibold [&_h2]:text-slate-900",
        "[&_h3]:mt-2.5 [&_h3]:mb-1 [&_h3]:text-[13px] [&_h3]:font-semibold [&_h3]:text-slate-900",
        "[&_h4]:mt-2 [&_h4]:mb-1 [&_h4]:text-[12.5px] [&_h4]:font-semibold [&_h4]:text-slate-900",
        ...
        "[&_pre]:my-2 [&_pre]:overflow-x-auto [&_pre]:rounded-xl [&_pre]:border [&_pre]:border-white/55 [&_pre]:bg-white/55 [&_pre]:p-3 [&_pre]:text-[12px]",
        ...
        "[&_th]:border [&_th]:border-white/55 [&_th]:bg-white/45 [&_th]:px-2 [&_th]:py-1 [&_th]:text-left [&_th]:font-semibold",
        "[&_td]:border [&_td]:border-white/55 [&_td]:px-2 [&_td]:py-1",
        className,
      )}
    >
      <ReactMarkdown
