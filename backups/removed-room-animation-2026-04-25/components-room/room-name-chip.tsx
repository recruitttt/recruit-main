...
/**
 * Floating billboard above the character's head. Always readable regardless of
 * camera angle. Text grows slightly on hover; the current stage + company shows
 * only when hovered or selected.
 */
export function RoomNameChip({ agentId }: Props) {
      ...
      >
        <div
          style={{
            ...
            border: `1px solid ${active ? agent.hue : "rgba(15,15,18,0.08)"}`,
            boxShadow: active
              ? `0 6px 18px -8px ${agent.hue}66, 0 2px 6px -2px rgba(15,15,18,0.12)`
        ...
        >
          <span
            style={{
              ...
              boxShadow: `0 0 6px ${agent.hue}AA`,
            }}
          />
          <span
            style={{
