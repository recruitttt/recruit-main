...
export const dashboardSeed: DashboardSeed = {
  ...
  metrics: [
    ...
    { label: "DLQ pending", value: "4", detail: "2 need approval", tone: "warning", progress: 38 },
  ...
  applications: [
    ...
    { company: "Radiant", role: "SWE Intern", provider: "Greenhouse", match: "84%", status: "blocked", tone: "danger", artifact: "DLQ" },
  ],
  dlq: [
  ...
  activity: [
    ...
    { time: "09:14", type: "decision", title: "Stopped for approval", detail: "Work authorization question requires verified candidate truth.", evidence: "DLQ" },
