    ...
    <div className="mx-auto max-w-7xl px-6 py-8">
      ...
      <div className="mb-7 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <span className="flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 py-1 pl-2 pr-3 text-[11px] font-mono">
            ...
            <span className="text-emerald-300 uppercase tracking-[0.15em] text-[10px]">Agent live</span>
          </span>
        </div>
      </div>
      ...
      {dlqCount > 0 && (
        <Link
          href="/dlq"
          className="group mb-6 flex items-center justify-between rounded-lg border border-amber-500/30 bg-amber-500/5 px-5 py-3.5 transition-colors hover:border-amber-500/50 hover:bg-amber-500/10"
        >
          <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1.5 text-[12px] font-mono text-amber-300 group-hover:translate-x-0.5 transition-transform">
